...
export function makeStory(overrides: Partial<Story> = {}): Story {
  return {
    ...
    rawStory: 'Lost the demo bag, rebuilt the env, led with the numbers.',
    storytelling:
      'An hour before my talk the airline lost my demo laptop, so I rebuilt the environment from a backup and led with the live numbers instead.',
    score: 8,
